...
const helloMessage = sayHello('Andy');
...
const userBillTotal = prompt("Enter the bill total:");
const userTipPercentage = prompt("Enter the tip percentage:");
const totalTipAmount = calculateTip(userTipPercentage, userBillTotal);
