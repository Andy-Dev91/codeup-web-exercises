"use strict";
console.log("Inside conditions.js")
/* ########################################################################## */
...
console.log(calculateTotal(5, 123456789));
...
function alertEvenOrOdd(number) {
    // -------------- Even or Odd -----------------
    // These two lines are the same as the next 11
...
function alertNumPlus100(number) {
    // -------------- Number plus 100 -----------------
    const numPlus100 = number + 100;
    alert(`${number} + 100 = ${numPlus100}`);
}

function alertPositiveOrNegative(number) {
...
if(userContinue) {
    ...
    if(!isNaN(userNumber)) {
        ...
        alertNumPlus100(userNumber);
        alertPositiveOrNegative(userNumber);
    } else {
